...
export default function MemberHeroCard({ member, onQrPress }: MemberHeroCardProps) {
      ...
      <View className="flex-row items-center justify-between" style={RTL_CONTAINER_STYLE}>
        <View className="flex-row items-center gap-2.5" style={RTL_CONTAINER_STYLE}>
          ...
          <View className="items-start gap-3">
            ...
            <Text className="text-sm text-primary" style={{ fontFamily: cairo.semiBold, ...RTL_TEXT_STYLE }}>
              {member.federationId}
            </Text>
          </View>
        </View>
