...
const PLAYER_PHOTOS: Record<MemberPhotoIndex, number> = {
  ...
  2: require('@/assets/images/members/player-2.png'),
...
const ADMIN_PHOTOS: Record<1 | 2 | 3 | 4 | 5, number> = {
  1: require('@/assets/images/members/admin-1.png'),
  2: require('@/assets/images/members/admin-2.png'),
...
export function memberPhotoSource(category: MemberCategory, photoIndex: MemberPhotoIndex) {
  switch (category) {
    case 'player':
    ...
    case 'administrator':
      return ADMIN_PHOTOS[(photoIndex <= 5 ? photoIndex : 1) as 1 | 2 | 3 | 4 | 5];
    default: {
