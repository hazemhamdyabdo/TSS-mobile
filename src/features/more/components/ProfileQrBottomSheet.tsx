...
import { QR_BADGE_ICON_XML } from '@/features/members/constants/iconXml';
import { cairo } from '@/theme/typography';
import { presentBottomSheet } from '@/utils/presentBottomSheet';

const qrCodeImage = require('@/assets/images/QR.png');

export type ProfileQrBottomSheetRef = {
  open: () => void;
  close: () => void;
};

type ProfileQrBottomSheetProps = {
  federationId: string;
};

export default forwardRef<ProfileQrBottomSheetRef, ProfileQrBottomSheetProps>(
  function ProfileQrBottomSheet({ federationId }, ref) {
      ...
      >
        <BottomSheetView className="items-center gap-4 px-5 pb-8 pt-2">
          ...
          <Image
            ...
            contentFit="contain"
            accessibilityLabel={t('more.profile.qrTitle')}
          />
