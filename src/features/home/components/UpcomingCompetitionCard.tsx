  ...
  return (
    ...
    >
      <View className="flex-row items-center gap-2" style={RTL_CONTAINER_STYLE}>
        <View className="h-[63px] w-[124px] overflow-hidden rounded-lg">
          <Image
            source={CARD_IMAGE}
            style={{ width: 124, height: 63 }}
            contentFit="cover"
          />
        </View>
        <View className="min-w-0 flex-1 gap-1">
          <Text
            className="text-xs capitalize tracking-[0.1px] text-accent"
            style={{ fontFamily: cairo.medium, ...RTL_TEXT_STYLE }}
            numberOfLines={1}
          >
          ...
          <View
            className="flex-row flex-wrap gap-x-2 gap-y-1"
            style={RTL_CONTAINER_STYLE}
          >
            <MetaItem
