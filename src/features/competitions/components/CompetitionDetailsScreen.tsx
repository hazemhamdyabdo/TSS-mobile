...
export default function CompetitionDetailsScreen() {
  ...
  const handleDelete = () => {
    ...
    Alert.alert(t('competitions.actions.delete'), t('competitions.actions.deleteConfirm'), [
  ...
  return (
    <ScreenSafeAreaView className="flex-1 bg-background" edges={['top']} style={RTL_CONTAINER_STYLE}>
      ...
      <View className="flex-row items-center justify-between px-5 py-3" style={RTL_CONTAINER_STYLE}>
        ...
        <Pressable
          ...
          <MaterialDesignIcons name="dots-vertical" size={24} color={colors.accent} />
        </Pressable>
      </View>
