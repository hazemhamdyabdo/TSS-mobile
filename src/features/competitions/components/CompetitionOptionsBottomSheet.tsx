    ...
    <BottomSheetModal
      ...
      <BottomSheetView className="gap-2 px-5 pb-8 pt-2">
        <Pressable
          ...
          className="h-14 flex-row items-center gap-3 rounded-xl bg-slate-50 px-3"
          style={RTL_CONTAINER_STYLE}>
          <View className="size-10 items-center justify-center rounded-lg bg-primary/10">
            <MaterialDesignIcons name="pencil-outline" size={20} color={colors.primary} />
          </View>
          <Text className="text-sm text-accent" style={{ fontFamily: cairo.medium, ...RTL_TEXT_STYLE }}>
        ...
        <Pressable
          ...
          <View className="size-10 items-center justify-center rounded-lg bg-rejected/10">
            <MaterialDesignIcons name="trash-can-outline" size={20} color={colors.rejected} />
          </View>
          <Text className="text-sm text-rejected" style={{ fontFamily: cairo.medium, ...RTL_TEXT_STYLE }}>
