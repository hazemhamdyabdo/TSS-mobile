...
export default function LoginContent({ onOtpRequested, onContactPress }: LoginContentProps) {
  ...
  return (
    <View className="w-full items-center gap-8 py-2">
      ...
      <LoginForm onOtpRequested={onOtpRequested} onContactPress={onContactPress} />
    </View>
  );
}
